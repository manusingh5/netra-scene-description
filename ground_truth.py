    ...
    "test_video1.mp4": {
        ...
        "frames": {
            0: {
                ...
                "expected_caption": (
                    "A busy city street with several cars, a bus, "
                    "pedestrians, and tall buildings."
                ),
                "expected_text": [
                    "E Washington St",
                    "ONE WAY"
            ...
            10: {
                ...
                "expected_caption": (
                    "A busy downtown street with a bus, several cars, "
                    "a taxi, and pedestrians."
                ),
                "expected_text": [
                    "E Washington St",
                    "ONE WAY",
                    "151 TO UNION STATION"
                ]
            },
            ...
            20: {
                ...
                "expected_caption": (
                    "A city bus is stopped on a busy downtown street "
                    "with cars and pedestrians around it."
                ),
                "expected_text": [
                    "E Washington St",
                    "ONE WAY",
            ...
            30: {
                ...
                "expected_caption": (
                    "A city bus is at a bus stop on a downtown street "
                    "with several cars and pedestrians."
                ),
                "expected_text": [
                    "E Washington St",
                    "ONE WAY",
            ...
            40: {
                ...
                "expected_caption": (
                    "A large city bus passes close to the camera "
        ...
        "frames": {
            0: {
                ...
                "expected_caption": (
                    ...
                    "with luggage and luggage carts."
                ),
                "expected_text": [
                    "Emergency Exit",
                    "Gates",
...
def get_all_classes():
    """Return all unique YOLO object classes across all videos."""
    classes = set()
...
def get_all_text():
    """Return all unique expected OCR text strings across all videos."""
    texts = set()
